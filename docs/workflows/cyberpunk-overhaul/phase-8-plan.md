...
- [x] Create the directory `.pi/skills/game-math-reviewer/`.
- [x] Convert `game-math-reviewer-persona.md` into `.pi/skills/game-math-reviewer/SKILL.md`.
...
- [x] Modify `.pi/skills/cyberpunk-overhaul/SKILL.md`.
...
- [x] Update `.pi/skills/game-tester/SKILL.md` to include a "Balance Testing" mode.
