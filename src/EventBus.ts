...
export const UI_EVENTS = {
  ...
  BANK_PAY_DEBT: 'UI_INTENT_BANK_PAY_DEBT',
  APPLY_JOB: 'UI_INTENT_APPLY_JOB',
  TAKE_COURSE: 'UI_INTENT_TAKE_COURSE',
  STUDY: 'UI_INTENT_STUDY',
  HUSTLE_EXECUTE: 'UI_INTENT_HUSTLE_EXECUTE',
  BUY_ITEM: 'UI_INTENT_BUY_ITEM',
  RESTART_GAME: 'UI_INTENT_RESTART_GAME',
...
export const STATE_EVENTS = {
  CREDITS_CHANGED: 'STATE_CREDITS_CHANGED',  SAVINGS_CHANGED: 'STATE_SAVINGS_CHANGED',
  ...
  DEBT_CHANGED: 'STATE_DEBT_CHANGED',
  CAR_PURCHASED: 'STATE_CAR_PURCHASED',
