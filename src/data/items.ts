...
export const SHOPPING_ITEMS: Item[] = [
    ...
    { name: 'Omni-Chill', cost: 400, happinessBoost: 10, type: 'asset', icon: 'fridge', benefit: 'Bio-Deficit Rate -50%', location: 'Shopping Mall' },
    { name: 'Hypno-Screen', cost: 600, happinessBoost: 40, type: 'asset', icon: 'television', benefit: 'Morale Bonus +10%', location: 'Shopping Mall' },
    ...
    { name: 'Monolith Burger', cost: 10, happinessBoost: 5, type: 'essential', hungerReduction: 40, location: 'Sustenance Hub' },
