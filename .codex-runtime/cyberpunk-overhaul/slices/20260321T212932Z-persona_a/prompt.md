...
## Runner Context
- Startup context file: /home/silwerdivan/code/jones-vibes/.codex-runtime/cyberpunk-overhaul/slices/20260321T212932Z-persona_a/startup-context.json
- Continuity artifact: /home/silwerdivan/code/jones-vibes/.codex-runtime/cyberpunk-overhaul/slices/20260321T212932Z-persona_a/continuity.json
...
- Latest checkpoint save file: docs/workflows/cyberpunk-overhaul/checkpoints/persona_a/week-06-save.json
- Expected next action: Resume Persona A from the authoritative Week 6 checkpoint or live summary state in `phase11-safe-grinder`, advance exactly one completed in-game week, start from the Week 6 summary anchor `₡616 / Debt ₡0 / Hunger 20% / Sanity 15 / Sore Legs 6h`, confirm whether the AI handoff remains stable, and verify whether the restored `Work Shift x3` route holds once `Sore Legs` is almost gone. Write the canonical `docs/workflows/cyberpunk-overhaul/phase-11-slices/persona-a/week-07.md` before exporting the Week 7 checkpoint.
