...
## Runner Context
- Startup context file: /home/silwerdivan/code/jones-vibes/.codex-runtime/cyberpunk-overhaul/slices/20260323T142601Z-persona_a/startup-context.json
- Continuity artifact: /home/silwerdivan/code/jones-vibes/.codex-runtime/cyberpunk-overhaul/slices/20260323T142601Z-persona_a/continuity.json
...
- Latest checkpoint save file: docs/workflows/cyberpunk-overhaul/checkpoints/persona_a/week-09-save.json
- Expected next action: Resume Persona A from the authoritative Week 9 checkpoint. Player starts Week 10 at ₡380 / Hunger 80% / Sanity 45 with TRAUMA_REBOOT active. Objective: Survival. Since hunger is at 80% (exhaustion protocol limit for trauma), Player MUST consume food this turn or face game over (energy drain failure). Travel to Sustenance Hub, buy Real-Meat Burger x2 (if possible) or whatever food is available. Credits ₡380 is enough for food.
