...
- [x] Scan all files in `.pi/skills/` for mentions of `opencode` and remove/rewrite those sections, or delete entire skills that are solely `opencode`-specific. (Verified no references exist)
