...
- [x] Update `main.ts` to load existing save data on startup
- [x] Replace `PlaceholderScreen` for "Menu" with a functional `SystemScreen`
- [x] Add "Restart Game" functionality with confirmation modal in `SystemScreen`
